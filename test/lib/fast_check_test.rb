...
class FastCheckTest < Minitest::Test
  ...
  # fires for free (CI, bin/full-suite-check, the release gate workspace -- all green)
  # never fires here, and on a virgin worktree every view-rendering test errored with
