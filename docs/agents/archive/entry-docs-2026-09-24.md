# Entry docs before the map — archived 2026-09-24

Frozen record. On 2026-09-24 (epic devops-v3, pieces 5a and 5c) the entry docs
were cut to a map: `docs/agents/index.md` (installs as `AGENTS.md`) went from
1,119 lines to about 200, and `docs/agents/claude.md` (installs as `CLAUDE.md`)
from 377 lines to a thin adapter. Nothing was dropped: both files are kept below
exactly as they stood at the cut, so every passage the map no longer carries is
here verbatim. The Start Here table moved live to `docs/agents/start-here.md`.

Do not edit this file to keep it current. The live rules are in the map and the
pages it links.

---

## Part 1 — `docs/agents/index.md`, verbatim
...
## Part 2 — `docs/agents/claude.md`, verbatim
