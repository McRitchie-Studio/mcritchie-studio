...
| `qa-contest-rehearsal` | Turf Monster | `mcritchie-studio/docs/agents/agents/turf_monster/sops/qa-contest-rehearsal.md` |
...
| Turf Monster QA contest rehearsal SOP | `mcritchie-studio/docs/agents/agents/turf_monster/sops/qa-contest-rehearsal.md` |
