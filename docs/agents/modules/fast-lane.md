...
| `turf-monster` · `rolio` · `mcritchie-industries` · `cyvasse` · `dads-app` · `tax-studio` · `chain-ops` | **Hub-absolute only.** The desk has no fast-lane scripts; only the cwd is the desk's |
