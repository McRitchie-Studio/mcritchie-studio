module ApplicationHelper
  ...
  def heartbeat_launchers
    [
      ...
      { agent_slug: "turf-monster", heartbeat: "Turf Monster Heartbeat", actions: ["live-score-watch", "qa-contest-rehearsal"], label: "Watch scores",  title: "Turf Monster — watch a live NFL slot, or rehearse a whole contest on QA" }
    ]
  end
  ...
  ACTION_DESCRIPTIONS = {
    ...
    "qa-contest-rehearsal" => "Rehearse a whole contest on QA, end to end",
