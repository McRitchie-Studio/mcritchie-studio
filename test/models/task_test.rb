...
class TaskTest < ActiveSupport::TestCase
  ...
  # outside tests calling Task.create! directly, while two docs told agents to
  # declare it. These cases pin the writer's half of that contract: the SHAPE the
  # reader resolves against, and the refusals that keep a declaration from being
  # stored in a form the reader silently ignores.
