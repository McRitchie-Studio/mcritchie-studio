...
| | `54_ai_builder_multiple_candidates.rb` | 11 editable public GitHub builder seed candidates/monitors, 6 AI builders and 5 control builders, with optional repo scopes. Seed candidate rows are marked in notes as placeholders; `amcritchie` is an owner-requested monitor account. |

**Totals:** 155 teams, 38 arenas, ~3000 people, ~2800 athletes, ~2800 contracts, plus 11 AI Builder Multiple seed candidates/monitors. All idempotent via `find_or_create_by!`.
