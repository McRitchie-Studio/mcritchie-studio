class Release
  ...
  module Conductor
    ...
    # EVERY repo it names. Raises ArgumentError naming the offending members, which
    # rolls the whole curation back (curate! / the CLI's batch sweep both run it
    ...
    #     (read off the group's repo), never the primary's.
