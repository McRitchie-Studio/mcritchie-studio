...
- [`HEARTBEAT.md`](HEARTBEAT.md) — Avi heartbeat review and production-ship launcher
- [`sops/production-deploy.md`](sops/production-deploy.md) — ship a QA-green
  release to production
- [`sops/pr-review.md`](sops/pr-review.md) — review submitted PRs in bounded waves
- [`sops/pr-review-slow.md`](sops/pr-review-slow.md) — review submitted PRs
  serially
