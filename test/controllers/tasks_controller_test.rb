...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "[component] current release condenses member tasks into highlights plus repo counts" do
    ...
    assert_select "#current-release a[href=?][data-release-member='highlight']", task_path(xl_turf.slug), text: /Expensive turf repair/
    assert_select "#current-release a[href=?][data-release-member='highlight']", task_path(large_studio.slug), text: /Large studio effort/
    ...
    assert_select "#current-release", { text: /Medium studio work/, count: 0 }
