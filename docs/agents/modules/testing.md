...
on the boot outcome, or a Rails desk whose boot broke would fail *open* — the exact hole
this guard closes. Inapplicable (no Rails app) ADMITS; unprovable (a Rails app we cannot
resolve) REFUSES.
