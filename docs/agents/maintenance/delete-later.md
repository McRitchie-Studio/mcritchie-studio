...
| `/Users/alex/projects/mcritchie-studio/.worktrees/pin-applications-ladder-row` | worktree | Hidden worktree; branch `feat/pin-applications-ladder-row` is clean and HEAD 08e4d69f is contained in origin/accepted; health up, Redis DB 13, database mcritchie_studio_development_pin_applications_ladder_row:ok Cleared: merged into origin/accepted, tree clean; no open PR for feat/pin-applications-ladder-row (GitHub asked); no live build claim on pin-applications-ladder-row; no review in progress; desk idle (born 13.5h ago, no writes in the last 1.5h). | Removed with `bin/agent-worktree remove mcritchie-studio pin-applications-ladder-row --yes` during approved lifecycle cleanup. | removed 2026-08-26 |

<!-- agent-worktree remove 2026-08-26 -->
| `/Users/alex/projects/mcritchie-studio/.worktrees/record-reclaimed-desk-audit` | worktree | Hidden worktree; branch `feat/record-reclaimed-desk-audit` is clean and HEAD 95240d6f is contained in origin/accepted; health down, Redis DB 15, database mcritchie_studio_development_record_reclaimed_desk_audit:missing Cleared: merged into origin/accepted, tree clean; no open PR for feat/record-reclaimed-desk-audit (GitHub asked); no live build claim on record-reclaimed-desk-audit; no review in progress; desk idle (born 12.8h ago, no writes in the last 1.5h). | Removed with `bin/agent-worktree remove mcritchie-studio record-reclaimed-desk-audit --yes` during approved lifecycle cleanup. | removed 2026-08-26 |

<!-- agent-worktree remove 2026-08-26 -->
| `/Users/alex/projects/turf-monster/.worktrees/_ship` | worktree | Hidden worktree; branch `` is clean and HEAD a5690f2 is contained in origin/accepted; health missing-env, Redis DB , database unknown Cleared: merged into origin/accepted, tree clean; no open PR for (detached — no branch) (GitHub asked); no live release conductor claim (assembler/deployer); desk idle (born 12.3h ago, no writes in the last 1.5h). | Removed with `bin/agent-worktree remove turf-monster _ship --yes` during approved lifecycle cleanup. | removed 2026-08-26 |

<!-- agent-worktree remove 2026-08-26 -->
| `/Users/alex/projects/turf-monster/.worktrees/audit-session-storage-architecture` | worktree | Hidden worktree; branch `feat/audit-session-storage-architecture` is clean and HEAD 8074836 is contained in origin/accepted; health down, Redis DB 58, database turf_monster_development_audit_session_storage_architecture:missing Cleared: merged into origin/accepted, tree clean; no open PR for feat/audit-session-storage-architecture (GitHub asked); no live build claim on audit-session-storage-architecture; no review in progress; desk idle (born 15.4h ago, no writes in the last 1.5h). | Removed with `bin/agent-worktree remove turf-monster audit-session-storage-architecture --yes` during approved lifecycle cleanup. | removed 2026-08-26 |
...
<!-- agent-worktree remove 2026-08-30 -->
| `/Users/alex/projects/turf-monster/.worktrees/cdp-setup-reads-agents-studio` | worktree | Hidden worktree; branch `feat/cdp-setup-reads-agents-studio` is clean and HEAD 7ff0216 is contained in origin/accepted; health down, Redis DB 38, database turf_monster_development_cdp_setup_reads_agents_studio:missing Cleared: merged into origin/accepted, tree clean; no open PR for feat/cdp-setup-reads-agents-studio (GitHub asked); no live build claim on cdp-setup-reads-agents-studio; no review in progress; desk idle (born 28.6h ago, no writes in the last 1.5h). | Removed with `bin/agent-worktree remove turf-monster cdp-setup-reads-agents-studio --yes` during approved lifecycle cleanup. | removed 2026-08-30 |
