...
That window is fixed, and **nothing renews it for you** — this lane has no
detached renewer the way a build claim and a review claim each do. So a sitting that
